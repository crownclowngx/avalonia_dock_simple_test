...
- V2 G14 已将 Core/UI public API 冻结到 v2 Shipped；V3 G8 的活动表面仍位于 v3 Unshipped，Host 自有实现不属于插件 API；
...
V3 G8 只运行上述非发布验证和本地 Windows x64 真实媒体资源门禁；Windows Smoke、ReleaseAcceptance 和发布总门禁留到 V3 G14。
