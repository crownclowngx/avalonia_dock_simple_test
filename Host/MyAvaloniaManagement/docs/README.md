...
| 规划本地 ZIP 安装、更新与启动恢复 | [V23 方案](../../../docs/roadmap/host-v23-local-zip-installation-plan.md)、[专用开发验证计划](../../../docs/roadmap/host-v23-local-zip-installation-verification.md)；尚未实施，沿用现有包格式，明确 SOLID、中文注释与本机验证 |
