...
当前仓库已完成未发布 V3 G9。Host 生产模块入口和声明式贡献目录使用本程序集，注册时一次绑定 Descriptor、
...
v3 Unshipped，v3 Shipped 为空。V3 G9 只用既有声明和 Host internal Workspace/Dock Adapter 验证
MyPlugTest，没有增加公共类型、接口或成员。v2 Shipped
