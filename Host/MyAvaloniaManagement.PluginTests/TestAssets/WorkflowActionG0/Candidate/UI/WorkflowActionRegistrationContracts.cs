...
/// <remarks>
/// 本接口与 <see cref="IPluginRegistration"/> 分离，使旧插件继续只依赖原有最小接口。
/// 候选 Host 的 internal 注册对象可以同时实现两个接口，而无需向 v3 已发布接口追加成员。
/// </remarks>
public interface IWorkflowActionRegistration
{
    /// <summary>声明由当前插件 Provider 创建的 scoped Handler。</summary>
