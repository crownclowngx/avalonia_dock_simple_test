...
{
    [Fact]
    public void 零插件时Registry为空而HostCatalog仍发布Welcome和两个Tool()
    {
        ...
        Assert.Empty(provider.GetRequiredService<MyAvaloniaManagement.Business.PluginStatus.IPluginStatusQuery>().Capture());
