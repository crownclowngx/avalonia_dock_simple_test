...
> 用途：V11 专用开发操作与故障排查。状态：当前；核对日期：2026-09-21。实现与实际结果见 [V11 开发记录](../archive/records/host-v11/development-acceptance.md)，使用说明见 [浮动窗口指南](../quick-start/floating-windows-and-layout.md)。
