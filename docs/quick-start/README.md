...
能够访问 NuGet.org。当前公开基线是 Plugin SDK `3.1.0`、manifest schema 2、Avalonia 12、Windows x64。

Workflow Action G2 已验证并发布 SDK `3.1.0` / Templates `1.1.0`；Build 协议未变化，仍为 `1.1.2`。
