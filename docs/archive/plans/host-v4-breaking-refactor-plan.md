...
> [V3 G14 封板记录](../records/host-v3/g14-v3-sealing.md)、
> [V4 G8 封板记录](../records/host-v4/g8-v4-sealing.md)、
...
实际证据见 [G0 V3 源码基线](../records/host-v4/g0-v3-source-baseline.md)。未创建 V3 tag，且未上传或发布。
...
> 实施状态：已完成；证据见 [G0 V3 源码基线](../records/host-v4/g0-v3-source-baseline.md)。
...
> 实施状态：已完成；证据见 [G1 删除 Host 死面与依赖](../records/host-v4/g1-remove-dead-host-surface.md)。
...
> 实施状态：已完成；证据见 [G2 强类型身份与用例入口](../records/host-v4/g2-strongly-typed-identity-and-use-case-entry.md)。
...
> 实施状态：已完成；证据见 [G3 Layout 职责对齐](../records/host-v4/g3-layout-responsibility-alignment.md)。
...
> 实施状态：已完成；证据见 [G4 Document 控件回收器所有权](../records/host-v4/g4-document-control-recycling-ownership.md)。
...
> 实施状态：已完成；证据见 [G5 领域迁移](../records/host-v4/g5-domain-helper-migration.md)。
...
> 实施状态：已完成；证据见 [G6 路径语义与展示模型](../records/host-v4/g6-file-system-path-and-presentation-model.md)。
...
> 实施状态：已完成；证据见 [G7 四插件、Harness 与文档回归](../records/host-v4/g7-four-plugins-harness-documentation-regression.md)。
...
- **实际结果**：正式入口为 `scripts/Invoke-HostV4ReleaseGate.ps1`；Host 478/478、覆盖率
  ...
  [G8 专用记录](../records/host-v4/g8-v4-sealing.md)。
