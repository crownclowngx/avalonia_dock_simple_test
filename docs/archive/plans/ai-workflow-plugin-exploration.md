...
- [`external-managed-plugin-development-and-installation-plan.md`](../../maintenance/nuget-release.md)
...
- [`Workflow Action G0 冻结记录`](../records/workflow-action/g0-facts-naming-repositories-sdk-compatibility.md)
- [`Workflow Action G1 Host 内核记录`](../records/workflow-action/g1-host-workflow-action-kernel.md)
- [`Workflow Action G2 SDK/Build/模板传播记录`](../records/workflow-action/g2-sdk-build-external-template-propagation.md)
- [`Workflow Action G3 外部 Studio 记录`](../records/workflow-action/g3-workflow-studio-fake-action-loop.md)
- [`Workflow Action G3.1 协议一致性记录`](../records/workflow-action/g3.1-workflow-protocol-consistency.md)
- [`Workflow Action G4 MySmallTools 非破坏性加密记录`](../../../../avalonia_dock_plug_test/myavalonia-video-security-player/docs/plan-history/workflow-action/g4-my-small-tools-nondestructive-encryption-action.md)
...
- 专项旧 Host 1/1、候选协议 14/14 通过；详细命令、包摘要、SOLID 取舍和非发布边界见
  [G0 专用记录](../records/workflow-action/g0-facts-naming-repositories-sdk-compatibility.md)。
...
> **状态：已完成（2026-08-25）；实现与非发布证据见 [G1 专用记录](../records/workflow-action/g1-host-workflow-action-kernel.md)。**
...
> **状态：已完成（2026-08-25）；实现与非发布证据见 [G2 专用记录](../records/workflow-action/g2-sdk-build-external-template-propagation.md)。**
...
> **状态：已完成（2026-08-25）；实现与非发布证据见 [G3 专用记录](../records/workflow-action/g3-workflow-studio-fake-action-loop.md)。**
>
...
> **状态：已完成实现；证据见 [G3.1 专用记录](../records/workflow-action/g3.1-workflow-protocol-consistency.md)。**
