...
> 当前验收统一使用 Gate CLI；本文中的旧脚本入口仅记录历史执行事实。<br>
...
历史阶段桥的建立原因仍见 [V2 G2 记录](../records/host-v2/g2-plugin-sdk-rebuild.md)。
...
[`document-persistence-v2-design.md`](../../reference/document-persistence.md)。
...
[`IBiliDownloaderEventBus.cs`](../../../../avalonia_dock_plug_test/myavalonia-bili-downloader/src/BiliDownloaderPlugin.Plugin/Messaging/IBiliDownloaderEventBus.cs)。
...
[G4 Managed-only 插件加载记录](../records/host-v1/g4-managed-only-plugin-loading.md)。
...
[G6 宿主 DI 保护](../records/host-v1/g6-host-di-protection.md)。
...
[G14 V2 封板记录](../records/host-v2/g14-v2-sealing.md)。
...
非发布声明与回滚边界见
[G7 Host Catalog 与 Plugin Registry](../records/host-v3/g7-host-catalog-and-plugin-registry.md)。
...
回滚边界见 [G8 全屏租约与 Host V3 骨架](../records/host-v3/g8-fullscreen-lease-and-host-v3-skeleton.md)。
...
[G9 MyPlugTest V3 验收](../records/host-v3/g9-my-plug-test-v3-acceptance.md)。
...
兼容边界与回滚单位见 [G10](../../../../avalonia_dock_plug_test/myavalonia-datang-work/docs/plan-history/host-v3/g10-datang-accounting-help-v3-acceptance.md)、
[G11](../../../../avalonia_dock_plug_test/myavalonia-video-security-player/docs/plan-history/host-v3/g11-my-small-tools-v3-acceptance.md) 和
[G12](../../../../avalonia_dock_plug_test/myavalonia-bili-downloader/docs/plan-history/host-v3/g12-bili-downloader-v3-acceptance.md) 专项记录。
...
完整证据见 [G7 四插件、Harness 与文档回归](../records/host-v4/g7-four-plugins-harness-documentation-regression.md)。
...
[G8 V4 封板记录](../records/host-v4/g8-v4-sealing.md)。
