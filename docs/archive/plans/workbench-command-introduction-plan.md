...
- **状态**：已完成（2026-08-28）；实际证据见
  [G1 兼容契约与注册声明实施记录](../records/workbench-command/g1-command-contracts-registration-declarations.md)。
...
- **状态**：已完成（2026-08-28）；实际证据见
  [G2 无 UI Catalog 与 Executor 实施记录](../records/workbench-command/g2-command-catalog-executor.md)。
...
- **状态**：已完成（2026-08-28）；实际证据见
  [G3 Context v1 与活动 Document Target 路由实施记录](../records/workbench-command/g3-context-active-document-target-routing.md)。
...
- **状态**：已完成（2026-08-28）；实际证据见
  [G4 Host 打开/保存 Presentation 真实闭环实施记录](../records/workbench-command/g4-host-open-save-presentation-loop.md)。
...
- **状态**：已完成（2026-08-28）；实际证据见
  [G5 声明式 Menu 与 KeyBinding Projection 实施记录](../records/workbench-command/g5-declarative-menu-keybinding-projection.md)。
...
- **状态**：已完成（2026-08-28）；实际证据见
  [G6 SDK 3.3、模板与独立消费实施记录](../records/workbench-command/g6-sdk-candidate-template-independent-consumption.md)。
...
- **状态**：已完成（2026-08-28）；实际证据见
  [G7 WorkflowStudio 三条真实命令实施记录](../records/workbench-command/g7-workflow-studio-three-real-commands.md)。
...
- **状态**：已完成；实施与回滚证据见
  [G8 专项记录](../records/workbench-command/g8-classic-game-multi-instance-commands.md)。
...
- **状态**：已完成；实施、测试、SOLID 取舍与整体回滚证据见
  [G9 专项记录](../records/workbench-command/g9-minimal-command-palette.md)。
...
- **状态**：已完成（2026-08-29）；实施、SOLID 取舍、单轮完整证据与回滚见
  [G10 专项记录](../records/workbench-command/g10-cross-repository-integration-sealing.md)。
