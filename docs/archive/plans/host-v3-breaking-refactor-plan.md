...
> [V2 G14 封板记录](../records/host-v2/g14-v2-sealing.md)、
> [V3 G0 非发布绿色基线](../records/host-v3/g0-green-baseline.md)、
> [V3 G1 版本与数据边界](../records/host-v3/g1-version-and-data-boundaries.md)、
...
> [V3 G4 插件注册所有权](../records/host-v3/g4-plugin-registration-ownership.md)、
> [V3 G5 插件私有消息](../records/host-v3/g5-plugin-private-messaging.md)、
> [V3 G6 Workspace Session 与 Dock Factory](../records/host-v3/g6-workspace-session-and-dock-factory.md)、
> [V3 G7 Host Catalog 与 Plugin Registry](../records/host-v3/g7-host-catalog-and-plugin-registry.md)、
> [V3 G8 全屏租约与 Host V3 骨架](../records/host-v3/g8-fullscreen-lease-and-host-v3-skeleton.md)、
> [V3 G9 MyPlugTest 验收](../records/host-v3/g9-my-plug-test-v3-acceptance.md)、
> [V3 G10 DaTangAccountingHelpPlug 验收](../../../../avalonia_dock_plug_test/myavalonia-datang-work/docs/plan-history/host-v3/g10-datang-accounting-help-v3-acceptance.md)、
> [V3 G11 MySmallTools 验收](../../../../avalonia_dock_plug_test/myavalonia-video-security-player/docs/plan-history/host-v3/g11-my-small-tools-v3-acceptance.md)、
> [V3 G12 BiliDownloader 验收](../../../../avalonia_dock_plug_test/myavalonia-bili-downloader/docs/plan-history/host-v3/g12-bili-downloader-v3-acceptance.md)、
> [V3 G13 删除 V2 生产面](../records/host-v3/g13-remove-v2-production-surface.md)、
> [V3 G14 封板](../records/host-v3/g14-v3-sealing.md)、
...
完整结果见 [G0 专项记录](../records/host-v3/g0-green-baseline.md)。本轮 Host Unit/UI/Plugin 为
...
- **生产变化**：无；只增加测试、文档门禁和 [G0 专项记录](../records/host-v3/g0-green-baseline.md)。
...
- **实施记录**：版本、API 文本、磁盘兼容、SOLID 取舍与非发布门禁结果见
  [G1 专项记录](../records/host-v3/g1-version-and-data-boundaries.md)。
...
- **实施记录**：最终 API、保存/关闭时序、三插件策略、157/157 专项测试、全量覆盖率和非发布边界见
  [G2 专项记录](../records/host-v3/g2-revisioned-document-save.md)。
...
- **实施记录**：最终 API、Host 与 11 个插件 Document 的支持矩阵、143/143 专项门禁、全量覆盖率和
  非发布边界见 [G3 专项记录](../records/host-v3/g3-exclusive-document-activation.md)。
...
- **实施记录**：最终提交时序、保留类型、四插件 ID 矩阵、58/58 专项门禁、全量覆盖率和非发布边界见
  [G4 专项记录](../records/host-v3/g4-plugin-registration-ownership.md)。
...
- **实施记录**：最终接口、消息拓扑、SOLID 取舍、删除面、165/165 专项测试、两个重点文件 97.72%
  行覆盖率、四插件确定性包和非发布边界见
  [G5 专项记录](../records/host-v3/g5-plugin-private-messaging.md)。
...
- **实施记录**：最终职责图、对象所有权、回调与退出时序、SOLID 取舍、441/441 专项测试、Host
  ...
  [G6 专项记录](../records/host-v3/g6-workspace-session-and-dock-factory.md)。
...
- **实施记录**：最终职责图、对象/Provider 所有权、同步 Host 与异步插件激活、失败回滚、SOLID 取舍、
  ...
  [G7 专项记录](../records/host-v3/g7-host-catalog-and-plugin-registry.md)。
...
- **实施记录**：租约/窗口/Document 时序、SOLID 取舍、owner API 删除面、672/672 专项测试、Host
  ...
  [G8 专项记录](../records/host-v3/g8-fullscreen-lease-and-host-v3-skeleton.md)。
...
- **实施记录**：最终 Workspace 创建/发布/关闭、Host Revision 保存竞争、严格 schema 1、私有消息订阅、
  ...
  11 文件确定性 ZIP 见 [G9 专项记录](../records/host-v3/g9-my-plug-test-v3-acceptance.md)。
...
- **实施记录**：真实 Workspace/Dock/DocumentSaveService 链、Revision 保存竞争、文件选择取消与迟到结果隔离、
  ...
  见 [G10 专项记录](../../../../avalonia_dock_plug_test/myavalonia-datang-work/docs/plan-history/host-v3/g10-datang-accounting-help-v3-acceptance.md)。
...
- **实施记录**：四个非持久化 Document 的最终 Workspace 链、全屏租约排他/幂等释放、20 轮真实媒体资源与
  ...
  以及两次 431 文件确定性 ZIP 见 [G11 专项记录](../../../../avalonia_dock_plug_test/myavalonia-video-security-player/docs/plan-history/host-v3/g11-my-small-tools-v3-acceptance.md)。
...
- **实施记录**：真实 Host 保存竞争、插件私有消息全行为、Lifecycle/readiness/全新对象图恢复、最终
  ...
  [G12 专项记录](../../../../avalonia_dock_plug_test/myavalonia-bili-downloader/docs/plan-history/host-v3/g12-bili-downloader-v3-acceptance.md)。
...
- **实施记录**：版本无关测试夹具、活动源码与二进制零残留、真实 NuGet 十四个反向消费者、Host
  ...
  [G13 专项记录](../records/host-v3/g13-remove-v2-production-surface.md)。
...
- **实施记录**：Core/UI v3 Shipped 已固定为 127/45，Unshipped 均为 0；独立 V3 Core、单元测试和
  ...
  Smoke、机器摘要和无外部发布边界见 [G14 专项记录](../records/host-v3/g14-v3-sealing.md)。
