...
> [V2 G0 非发布绿色基线](../records/host-v2/g0-green-baseline.md)与
> [V2 G1 版本与数据边界](../records/host-v2/g1-version-and-data-boundaries.md)，以及
> [V2 G2 Plugin SDK 重建](../records/host-v2/g2-plugin-sdk-rebuild.md)与
> [V2 G3 manifest v2 与构建协议](../records/host-v2/g3-manifest-v2-and-build-protocol.md)，以及
> [V2 G4 每插件独立容器](../records/host-v2/g4-per-plugin-containers.md)与
> [V2 G5 声明式贡献目录](../records/host-v2/g5-declarative-contribution-catalog.md)与
> [V2 G6 Host Dock Adapter](../records/host-v2/g6-host-dock-adapter.md)与
> [V2 G7 Document V2](../records/host-v2/g7-document-v2.md)与
> [V2 G8 布局与生命周期 V2](../records/host-v2/g8-layout-and-lifecycle-v2.md)与
> [V2 G9 MyPlugTest 迁移](../records/host-v2/g9-my-plug-test-v2.md) 和
> [V2 G10 DaTang 迁移](../../../../avalonia_dock_plug_test/myavalonia-datang-work/docs/plan-history/host-v2/g10-datang-accounting-help-v2.md)和
> [V2 G11 MySmallTools 迁移](../../../../avalonia_dock_plug_test/myavalonia-video-security-player/docs/plan-history/host-v2/g11-my-small-tools-v2.md)和
> [V2 G12 BiliDownloader 迁移](../../../../avalonia_dock_plug_test/myavalonia-bili-downloader/docs/plan-history/host-v2/g12-bili-downloader-v2.md)和
> [V2 G13 删除 V1 生产面](../records/host-v2/g13-remove-v1-production-surface.md)与
> [V2 G14 封板](../records/host-v2/g14-v2-sealing.md)。
>
...
- **变更**：在 [G0 专项记录](../records/host-v2/g0-green-baseline.md) 中增加 V2 删除面清单、
...
[G1 专项记录](../records/host-v2/g1-version-and-data-boundaries.md)。
...
[G2 专项记录](../records/host-v2/g2-plugin-sdk-rebuild.md)。本阶段没有实现 manifest v2、独立插件容器、
...
[G3 专项记录](../records/host-v2/g3-manifest-v2-and-build-protocol.md)。本阶段没有迁移独立容器、
...
[G4 专项记录](../records/host-v2/g4-per-plugin-containers.md)。本阶段没有实现 G5 声明式贡献、
...
完整设计、测试和阶段边界见
[G5 专项记录](../records/host-v2/g5-declarative-contribution-catalog.md)。G5 未实现 G6 Dock Adapter、
...
[G6 专项记录](../records/host-v2/g6-host-dock-adapter.md)。本阶段未调用 `InitializeAsync`，未实现
...
[G7 专项记录](../records/host-v2/g7-document-v2.md)。本阶段未修改 layout-v1 或生命周期编排，
...
释放顺序、SOLID 取舍与回滚边界见
[G9 专项记录](../records/host-v2/g9-my-plug-test-v2.md)。
...
[G10 专项记录](../../../../avalonia_dock_plug_test/myavalonia-datang-work/docs/plan-history/host-v2/g10-datang-accounting-help-v2.md)。
...
G11 已登记四个非持久化 Document，根模型均为普通 `ObservableObject` 并直接实现很小的
...
[G11 专项记录](../../../../avalonia_dock_plug_test/myavalonia-video-security-player/docs/plan-history/host-v2/g11-my-small-tools-v2.md)。

G11 非发布专项门禁实际 **275/275**；真实 G3 Harness 完成 20 轮并使全部原生资源计数回零。
两次隔离构建的 431 文件 ZIP 完全一致，归档 SHA-256 为
`2B2879D28D92A8251A21674D83F5752814AE2A09D0D01EED999061E168D38126`，最终 ZIP 通过真实
...
[G12 专项记录](../../../../avalonia_dock_plug_test/myavalonia-bili-downloader/docs/plan-history/host-v2/g12-bili-downloader-v2.md)。
...
[G13 专项记录](../records/host-v2/g13-remove-v1-production-surface.md)。
...
完整设计、SOLID 取舍、失败矩阵和实际证据见 [G14 专项记录](../records/host-v2/g14-v2-sealing.md)。
