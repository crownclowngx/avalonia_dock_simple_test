...
证据：部署结果（历史产物位置，文件已清理：`artifacts/host-deployment-20260912-085325/deployment-result.json`）、文件清单（历史产物位置，文件已清理：`artifacts/host-deployment-20260912-085325/deployment-files.json`）、隔离启动结果（历史产物位置，文件已清理：`artifacts/host-deployment-20260912-085325/startup-result.json`）、构建日志（历史产物位置，文件已清理：`artifacts/host-deployment-20260912-085325/publish.log`）。
