...
- [V9 生成物清理](./plan-history/host-v9/generated-artifacts-cleanup.md)：主仓与 11 插件仓库清理统计、保留证据和恢复构建方式。
...
- [工作区搜索与功能入口（V8）](quick-start/workbench-search.md)：功能、已有页面、工具和命令的发现、执行与失败恢复。
