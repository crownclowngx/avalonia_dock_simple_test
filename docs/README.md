...
- [V21 开发门禁与测试效能收敛](roadmap/host-v21-gate-and-test-efficiency-plan.md)：待实施；配套[专用开发验证计划](roadmap/host-v21-gate-and-test-efficiency-verification.md)，明确 SOLID、中文注释、夹具隔离、测试去向及本地开发门禁要求。
