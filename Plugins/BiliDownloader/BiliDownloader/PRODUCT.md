...
> 2026-08-02 产品基线更新：任务运行快照采用原子持久化和可失败 Flush；删除默认仅移除记录并由真实对话框选择文件范围；任务中心提供中文筛选、时间范围、跨筛选选择和 480px 响应式布局；Document V1/V2 配置恢复、完整下载预设、实时命名预览与冲突阻止提交已闭环。详细证据见 [G3–G5 激进式复核记录](doc/G3-G5-AGGRESSIVE-REVIEW-2026-08-02.md)。
