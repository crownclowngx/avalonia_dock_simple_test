...
> P1-G6 信息架构更新：Tool 已在本页定义的活动任务中心之外增加独立“历史”视图。
> 活动视图只展示非终态并保留原任务控制；完成、失败和取消进入历史，使用独立查询、
> 按需文件检查、新任务重下与安全导出服务。详细设计见
> [P1-G6 历史中心与安全导出](P1-G6-HISTORY-CENTER-SECURE-EXPORT.md)。
