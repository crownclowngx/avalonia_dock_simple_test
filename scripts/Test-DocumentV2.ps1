...
$suites = @(
    [pscustomobject]@{
        ...
        Filter = 'FullyQualifiedName~DocumentEnvelopeV2Tests|FullyQualifiedName~DocumentPersistenceTests|FullyQualifiedName~DocumentCloseTests|FullyQualifiedName~HostDockAdapterTests'
    },
    [pscustomobject]@{
        Name = 'G7-Plugin'
